...
---
A research project has a rough arc: get the scaffolding in place, pick a problem worth the time, then write it up so someone else can follow it. This is the version of that arc I actually use.
...
Once you've motivated the problem, organize prior work around an actual organizing principle — not just a list of papers in publication order. For each group of related work, cover what was done, what it taught us, what's still unknown, and how your paper addresses that gap.
