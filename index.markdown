...
<p>I am Ashutosh, an Applied Scientist with experience in building and deploying large-scale optimization and ML models in production systems. At BNSF Railway, I serve as Tech lead for network-wide scheduling and assignment systems, including a decision-support system that orchestrates railcar movements across all BNSF Railway's terminals, a workflow currently managed by 150+ operations managers.</p>
